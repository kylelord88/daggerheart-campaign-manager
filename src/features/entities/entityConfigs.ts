...
export const CHARACTER_CONFIG: EntityConfig = {
  ...
  fields: [
    ...
    { key: 'kind', label: 'Kind', kind: 'select', options: ['npc', 'pc'] },
    {
      ...
      label: 'Played By',
      kind: 'player',
      placeholder: 'Only relevant for PCs',
      playerOverrideFieldKey: 'played_by_override',
    },
    {
      key: 'played_by_override',
      label: 'Played By (override)',
      kind: 'text',
      placeholder: "Only shown if that player hasn't set a display name",
      hideFromDetailView: true,
    },
